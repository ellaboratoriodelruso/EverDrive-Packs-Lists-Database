...
$2 ~ /^Atari 2600\// { gsub("^Atari 2600", "MiSTer/ATARI2600", $2); print }

# EverDrive Pack SMDBs/Atari 5200 SMDB.txt
$2 ~ /^Atari 5200\// { gsub("^Atari 5200", "MiSTer/ATARI5200", $2); print }

# EverDrive Pack SMDBs/Colecovision SMDB.txt
$2 ~ /^Colecovision Atarimax\/COLECO\// { gsub("^Colecovision Atarimax/COLECO", "MiSTer/Coleco", $2); print }

# EverDrive Pack SMDBs/Darksoft Neo Geo SMDB.txt
$2 ~ /^Darksoft Neo Geo\/games\// { gsub("^Darksoft Neo Geo/games", "MiSTer/NeoGeo", $2); print }

# EverDrive Pack SMDBs/EverDrive GBA SMDB.txt
$2 ~ /^EverDrive GBA\// { gsub("^EverDrive GBA", "MiSTer/GBA", $2); print }

# EverDrive Pack SMDBs/EverDrive GB SMDB.txt
$2 ~ /^EverDrive GB\// { gsub("^EverDrive GB", "MiSTer/GAMEBOY", $2); print }

# EverDrive Pack SMDBs/EverDrive GG SMDB.txt
$2 ~ /^EverDrive GG\// { gsub("^EverDrive GG", "MiSTer/SMS/GameGear", $2); print }

# EverDrive Pack SMDBs/EverDrive N8 & PowerPak SMDB.txt
$2 ~ /^EverDrive N8\// { gsub("^EverDrive N8", "MiSTer/NES", $2); print }

# EverDrive Pack SMDBs/Master EverDrive SMDB.txt
$2 ~ /^Master EverDrive\// { gsub("^Master EverDrive", "MiSTer/SMS/MasterSystem", $2); print }

# EverDrive Pack SMDBs/Mega EverDrive SMDB.txt
$2 ~ /^Mega EverDrive\// { gsub("^Mega EverDrive", "MiSTer/Genesis", $2); print }

# EverDrive Pack SMDBs/Super EverDrive & SD2SNES SMDB.txt
$2 ~ /^SD2SNES\// { gsub("^SD2SNES", "MiSTer/SNES", $2); print }

# EverDrive Pack SMDBs/Turbo EverDrive & Super SD System 3 SMDB.txt
$2 ~ /^Turbo EverDrive\// { gsub("^Turbo EverDrive", "MiSTer/TGFX16", $2); print }

# EverDrive Pack SMDBs/Vectrex SMDB.txt
$2 ~ /^Vectrex\// { gsub("^Vectrex", "MiSTer/VECTREX", $2); print }
